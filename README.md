...
**版本 0.1.1：已完成电脑仿真与自动测试，尚未在你的 Kindle 上验证。** 不会自动连接设备。首次安装先诊断、校准，再启用完整接管。
...
产物：`dist/TodoClock-0.1.1.zip`、对应 SHA256 文件。打包脚本仅包含明确列出的代码、示例配置和文档，不包含本地配置、令牌、待办、日志或设备恢复记录。
